...
const categories = [
  { id: 1, name: 'Laptops', image: 'https://example.com/laptop.jpg', description: 'High-performance laptops for all your needs' },
  { id: 2, name: 'Smartphones', image: 'https://example.com/smartphone.jpg', description: 'Latest smartphones with cutting-edge technology' },
  { id: 3, name: 'Cameras', image: 'https://example.com/camera.jpg', description: 'Capture moments with high-quality cameras' },
  { id: 4, name: 'Headphones', image: 'https://example.com/headphones.jpg', description: 'Top-quality sound and noise-canceling headphones' },
  { id: 5, name: 'Smart Watches', image: 'https://example.com/smartwatch.jpg', description: 'Track fitness and stay connected with smart watches' },
  { id: 6, name: 'Gaming Consoles', image: 'https://example.com/console.jpg', description: 'Gaming consoles for an immersive experience' },
];
...
<div className="bg-gray-50 min-h-screen px-6 py-10">
      ...
      <div className="text-center mb-10">
        <h1 className="text-4xl font-bold text-gray-800 mb-2">Discover Electronics</h1>
        <p className="text-gray-600 mb-8">Explore the best in tech, from gadgets to gear.</p>
