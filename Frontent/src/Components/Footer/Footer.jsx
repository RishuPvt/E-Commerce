    ...
    <footer className="bg-gradient-to-b from-gray-900 to-gray-800 text-gray-300 p-10">
      <div className="container mx-auto grid grid-cols-1 md:grid-cols-4 gap-8">
        ...
        <div>
          ...
          <ul>
            <li>
              <a href="/help" className="hover:text-teal-400">
                Help Center
              </a>
            </li>
            <li>
              <a href="/shipping" className="hover:text-teal-400">
                Shipping & Delivery
              </a>
            </li>
            <li>
              <a href="/returns" className="hover:text-teal-400">
                Returns & Refunds
              </a>
            </li>
            <li>
        ...
        <div>
          ...
          <ul>
            <li>
              <a href="/categories/electronics" className="hover:text-teal-400">
                Electronics
              </a>
            </li>
            <li>
              <a href="/login" className="hover:text-teal-400">
                Account Login
              </a>
            </li>
            <li>
              <a href="/track-order" className="hover:text-teal-400">
                Order Tracking
              </a>
            </li>
            <li>
              <a href="/offers" className="hover:text-teal-400">
                Special Offers
              </a>
            </li>
          </ul>
...
<div className=""></div>
      ...
      <div className="mt-8 border-t border-gray-700 pt-4 text-center text-gray-400">
        ...
        <div className="flex justify-center space-x-4 mt-2">
          ...
          <a href="/cookies" className="hover:text-teal-400">
            Cookie Policy
          </a>
        </div>
      </div>
